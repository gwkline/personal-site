      ...
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            ...
            // Sizing.
            "[--drawer-content-height:var(--drawer-height,auto)] data-[swipe-axis=x]:[--drawer-content-width:75%] data-[swipe-axis=y]:[--drawer-content-max-height:min(calc(100dvh-6rem),calc(var(--app-height,100dvh)-6rem-var(--keyboard-inset,0px)))] data-[swipe-axis=y]:data-snap-points:[--drawer-content-height:var(--app-height,100dvh)] data-[swipe-axis=x]:sm:[--drawer-content-width:24rem]",
            // Stack.
